                                ...
                                <div class="timeline timeline-second-style clearfix">
                                    <div class="timeline-item clearfix">
                                        ...
                                        <div class="right-part">
                                            <h4 class="item-title"><a href="https://todolist-signup-in.herokuapp.com/" class="exercise success">How to work with NetBeans and Tomcat</a></h4>
                                    ...
                                    <div class="timeline-item clearfix">
                                        ...
                                        <div class="divider backround-success"></div>
                                        <div class="right-part">
                                            <h4 class="item-title"><a href="#" class="exercise success">A crash course in HTML5 and CSS3</a></h4>
